class Car2obj 
{
	public static void main(String[] args) 
	{
		...
		Car1[] cars={c1,c2,c3};
		Showroom sr=Showroom.getShowRoomDetails("Mahesh Jayaram","Marudhur",cars);
		sr.detailsOfShowRoom();
		System.out.println("\t\t\tCars Information in "+sr.getBranch()+"Showroom!!!");
		for(Car1 cr:sr.getCars()){
			cr.detailsOfCar();
		}
	}
}
